...
describe("Should render <SlideItem/>", () => {
  it('renders simple item with props', () => {
    render(<SlideItem title="Ermelino Matarazzo" img={ermelino} url="https://github.com/criar-art/slidecontent-react" target="_blank" />);
    ...
    expect(link_item.href).toBe('https://github.com/criar-art/slidecontent-react')
